...
// ***********************************************************************
// <copyright file="Reduce.cs" company="SiaNet.Backend.TensorSharp.CUDA91">
...
namespace SiaNet.Backend.TensorSharp.CUDA.DeviceCode.Headers
{
    /// <summary>
    /// Class Reduce.
    /// </summary>
    ...
    {
        /// <summary>
        /// The non contig reduce block size
        /// </summary>
