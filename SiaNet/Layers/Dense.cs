...
namespace SiaNet.Layers
{
    ...
    public class Dense : OptimizableLayerBase
    {
        ...
        /// <inheritdoc />
        internal override CNTK.Function ToFunction(CNTK.Variable inputFunction)
        {
            ...
            if (inputFunction.Shape.Rank != 1)
            {
                ...
                inputFunction = (Data.Function) CNTKLib.Reshape(inputFunction, new[] {newDim});
            }
            ...
            return Activation != null ? Activation.ToFunction((CNTK.Function) fullyConnected) : (CNTK.Function) fullyConnected;
        }
    }
}