...
namespace SiaNet
{
    public class Optimizers
    {
        ...
        public static Learner RMSprop(Function modelOutput, float learningRate = 0.001f, float gamma = 0.9f, float inc = 0, float dec = 0, double min = double.NegativeInfinity, double max = double.PositiveInfinity)
        {
            CNTK.TrainingParameterScheduleDouble learningRatePerSample = new CNTK.TrainingParameterScheduleDouble(learningRate, 1);
