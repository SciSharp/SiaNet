...
namespace SiaNet
{
    ...
    {
        public static Tensor Im2Col(Tensor x, Tuple<uint, uint, uint> kernalSize, int padding = 1, uint stride = 1)
        {
        ...
        public static Tensor Im2Col(Tensor x, Tuple<uint, uint> kernalSize, int padding= 1, uint stride = 1, Tuple<uint, uint> dialation=null)
        {
            if (dialation == null)
        ...
        public static Tensor Im2Col(Tensor x, uint steps, int padding = 1, uint stride = 1)
        {
        ...
        public static Tensor Col2Im(Tensor cols, long[] x_shape, Tuple<uint, uint, uint> kernalSize, int padding = 1, uint stride = 1)
        {
            return cols;
        }

        public static Tensor Col2Im(Tensor cols, long[] x_shape, Tuple<uint, uint> kernalSize, int padding = 1, uint stride = 1, Tuple<uint, uint> dialation = null)
        {
        ...
        public static Tensor Col2Im(Tensor cols, long[] x_shape, uint steps, int padding = 1, uint stride = 1)
        {
            return cols;
        }
    }
